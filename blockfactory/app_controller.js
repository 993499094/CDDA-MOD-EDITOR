...
AppController.prototype.initializeBlocklyStorage = function() {
  ...
  BlocklyStorage.LINK_ALERT =
      '用这个公共链接分享你您模块。如果一年内没有使用，我们将删除它们。它们与您的账户没有关联，并按照谷歌的隐私政策进行处理。请确保不包括任何私人信息：:\n\n%1';
  BlocklyStorage.HASH_ERROR =
      '很抱歉, "%1" 与任何保存的Blockly文件都不对应。';
  BlocklyStorage.XML_ERROR = '无法加载此保存文件。\n' +
      '也许它是用不同版本的Blockly创建的？';
